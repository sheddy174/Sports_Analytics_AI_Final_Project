...
def main():
    # Read Video
    video_frames = read_video('C:/Users/user/OneDrive - Ashesi University/Desktop/basketball_analysis_main/input_videos/Test_Video_2.mp4')  # 'input_videos/Test_Video.mp4'
